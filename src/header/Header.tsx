    ...
    <div className={s.headerBlock}>
      <div className={s.headerСontainer}>
        ...
        >
          <a>
            {!openBurgerMenu ?
              <svg  className={!openBurgerMenu ? s.svgItem  : s.svgItem + " " + s.active} width="45px" height="45px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 18L20 18" stroke="#000000" stroke-width="2" stroke-linecap="round"/>
                <path d="M4 12L20 12" stroke="#000000" stroke-width="2" stroke-linecap="round"/>
                <path d="M4 6L20 6" stroke="#000000" stroke-width="2" stroke-linecap="round"/>
              </svg> :
              <svg className={openBurgerMenu ? s.svgItem + " " + s.active : s.svgItem} width="45px" height="45px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
