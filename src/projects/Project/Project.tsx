...
export const Project = (props: ProjectProps) => {
  return (
    <div className={s.project}>
      <a href={props.href} target="_blank" className={s.projectDeploy}>
      ...
      <a href={props.hrefLinkToCode} target="_blank" className={s.linkToCode}>
        <svg viewBox="0 0 20 20" version="1.1" className={s.linkSvg}
        ...
        <span className={s.linkText}>Link to code</span>
      </a>
    </div>
  );
};
