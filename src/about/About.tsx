          ...
          <div className={s.aboutMe}>
            <div className={s.aboutMeSummary}>
              <h2 className={s.aboutMeTitle}>I'm <span
                ...
                Frontend
                Developer</h2>
              <p className={s.aboutMeText}>I'm a frontend-developer
                <b> with 1.5+ years </b> of experience with specializing in
                building a
                web applications and interfaces using <b> React, Redux (RTK, RTK
                  Query), TypeScript, JavaScript, HTML&CSS, and SCSS </b>. With
              ...
              <p className={s.aboutMeText}>Continuously expanding my knowledge
                ...
                <b> I am always eager to
                  ...
                  innovative projects in the front-end development field. </b>
                I am explore actively emerging technologies, collaborate
                effectively within teams and possess strong analytical
                abilities. I spend my free time reading educational literature,
